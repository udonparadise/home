...
export const select100: song[] = [
  ...
  },
  {
    name: '先輩 〜LOVE AGAIN〜',
    artist: Group.CG,
    artistSub: 'カントリー娘｡に紺野と藤本（モーニング娘｡）',
    year: 2003
  },
  {
    name: 'そうじゃない',
  ...
  {
    name: '都営大江戸線の六本木駅で抱きしめて',
    artist: Group.BEYO,
    artistSub: 'CHICA#TETSU',
    year: 2019
  },
  {
    name: 'ドッキドキ！LOVEメール',
